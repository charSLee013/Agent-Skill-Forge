...
- **[teach](./teach/SKILL.md)** — Build durable learning systems: concepts, skills, deep paper courses, repo courses, research routes, and long-course HTML artifacts with evidence, audits, and proof loops.

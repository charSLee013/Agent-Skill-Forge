...
**`/setup-agent-skills`** — run before your first engineering flow to configure the local `.codex/agents/` workspace, triage labels, and doc layout the other skills assume.

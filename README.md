...
用于需求澄清、代码交付、任务规划、写作、交接和论文学习的 33 个 Agent 技能。
...
| [antidetect-browser-lab](./skills/research/antidetect-browser-lab/SKILL.md) | 手动 | 安装或操作用户自有的 Donut/Wayfern 浏览器 profile；使用显式代理与本地 CDP。 |
